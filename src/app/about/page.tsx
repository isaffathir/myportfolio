  ...
  return (
    <div className="flex-row rounded-xl">
      <div className="flex-row w-full h-full">
        ...
        <LampContainer className="min-h-[150vh]">
          <motion.h1
          ...
          >
            <div className="flex items-center justify-center bg-gradient-to-br from-cyan-400 to-cyan-900 h-[80vh] w-[90vw] md:w-[90vw] lg:w-[80vw] xl:w-[70vw] rounded-xl tracking-tight">
              <iframe
                src="https://wintest.andrewstech.me/"
                className="m-1 h-[79vh] w-full rounded-xl tracking-tight"
              ></iframe>
            </div>
          </motion.h1>
        </LampContainer>
